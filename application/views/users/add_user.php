                                            ...
                                            <div class="fieldset">
                                                ...
                                                <div class="columns is-multiline">
                                                    ...
                                                    <div class="column is-6">
                                                        <div class="field">
                                                            <div class="control has-icon">
                                                                <input type="text" class="input" placeholder="First Name" name="first_name" value="<?php echo $user->admin_name;?>">
                                                                <div class="form-icon">
                                                    ...
                                                    <div class="column is-6">
                                                        <div class="field">
                                                            <div class="control has-icon">
                                                                <input type="text" class="input" placeholder="Last Name" name="last_name" value="<?php echo $user->admin_last_name;?>">
                                                                <div class="form-icon">
                                                                    <i data-feather="user"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="column is-12">
                                                        <div class="field">
                                                            <div class="control has-icon">
                                                                <input type="email" name="email" class="input" placeholder="Email" value="<?php echo $user->admin_email;?>">
                                                                <div class="form-icon">
                                                    ...
                                                    <div class="column is-12">
                                                        <div class="field">
                                                            <div class="control has-icon">
                                                                <input type="text" name="mobile_no" class="input" placeholder="Mobile No." value="<?php echo $user->admin_cell_phone;?>">
                                                                <div class="form-icon">
                                                ...
                                                <div class="fieldset-heading">
                                                 ...
                                                 <div class="columns is-multiline">
                                                    ...
                                                    <div class="column is-12">
                                                        <div class="field">
                                                            <div class="control has-icon">
                                                                <input type="text" class="input" placeholder="Zip Code." name="zip_code" value="<?php echo $user->zip_code;?>">
                                                                <div class="form-icon">
                                                    ...
                                                    <div class="column is-12">
                                                        <div class="field">
                                                            <div class="control">
                                                                <textarea class="textarea" rows="4" placeholder="Address" name="address"><?php echo $user->address;?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
