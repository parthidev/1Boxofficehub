                                ...
                                <tbody>
                                   ...
                                   <?php
                                       ...
                                       <?php foreach($roles as $role){ ?>
                                        <td><div class="control">
                                            <label class="checkbox">
                                              <input type="checkbox" name="role[<?php echo $role->admin_role_id;?>][<?php echo $menu_title_v[$jd]->privilege_functions_id;?>]">
                                              <span></span>
                                            </label>
                                          </div></td>
                                      <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="control">
                                            <label class="checkbox">
                                              <input type="checkbox" name="role[<?php echo $role->admin_role_id;?>][<?php echo $menu_title_v[$jd]->privilege_functions_id;?>][<?php echo $menu_module_v1[$k]->privilege_functions_id;?>]">
                                              <span></span>
                                            </label>
                                          </div></td>
                                       <?php } ?>
