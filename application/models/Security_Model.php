...
class Security_Model extends CI_Model
{
    ...
    public function admin_ip_track($type)
    {
        ...
        $this
            ->db
            ->insert('admin_login_tracking_details', $data);
        return $this
            ->db
            ->insert_id();
    }
       ...
       public function check_admin_login($username, $password = '')
    {
        ...
        $this
            ->db
            ->select('admin_login_details.*,admin_details.*,admin_type.admin_type as admin_type_name,admin_role_details.admin_roles_id as role_id')
        ...
        $this
            ...
            ->join('admin_role_details', 'admin_role_details.admin_id  = admin_login_details.admin_id', 'left');
            $this
                ->db
                ->where('admin_details.admin_status', 'ACTIVE');
     ...
     public function get_admin_details()
    {
            ...
            ->userdata('sa_id'))
        {
            ...
            $this
                ...
                ->where('super_admin_id', $admin_id)->where('super_admin_status', 'ACTIVE');
            $query = $this
                ->db
                ->get();
      ...
      public function get_user_details($admin_id)
    {
            ...
            $this
                ...
                ->select('*')
                ->from('admin_details')
                ->where('admin_details.admin_id', $admin_id)->where('admin_details.admin_status', 'ACTIVE');
            $this
            ->db
            ->join('user_details', 'user_details.user_id  = admin_details.user_id', 'left');
            $query = $this
                ->db
                ->get();
      ...
      public function admin_pattern_check($pattern)
    {
            ...
            ->userdata('admin_id'))
        {
            ...
            $this
                ...
                ->select('*')
                ->from('admin_login_details')
                ->where('admin_id', $admin_id)->where('admin_pattren', $pattern);
            $query = $this
                ->db
                ->get();
