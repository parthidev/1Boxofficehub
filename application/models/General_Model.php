...
class General_Model extends CI_Model
{
    ...
    public function get_admin_details()
    {
        ...
        $this->db->select('admin_details.*,address_details.*, countries.name')->from('admin_details')->where('admin_details.admin_id', $admin_id)->where('admin_status', 'ACTIVE')
        ->join('admin_login_details', 'admin_login_details.admin_id = admin_details.admin_id', 'left')->join('address_details', 'address_details.address_details_id = admin_details.address_details_id', 'left')->join('countries', 'countries.id = address_details.country', 'left');
        $query = $this->db->get();
    ...
    public function check_admin_password($password)
    {
        ...
        $aa = "SELECT admin_id FROM admin_login_details WHERE admin_password='$password' AND admin_id='".$this
            ->session
            ->userdata('admin_id')."'";
    ...
    function update_admin_details($update){
